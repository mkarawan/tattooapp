  ...
  return (
    <>
      ...
      <p className="artist-description">
        Jestem artystką w sercu i duszy, specjalizującą się w tatuowaniu. Skóra
        to moje płótno, na którym tworzę niezwykłe opowieści i wyrażam osobowość
        każdego, kto zasiada w moim fotelu.{" "}
      </p>
